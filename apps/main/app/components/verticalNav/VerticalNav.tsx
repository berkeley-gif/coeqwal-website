...
import { Box, Typography, IconButton, useTheme } from "@repo/ui/mui"
    ...
    <Box
      ...
      sx={{
        ...
        borderLeft: `2px solid ${
          isActive ? theme.palette.blue.darkest : "transparent"
        }`,
...
export default function VerticalNav({
  ...
  const NAV_TOP_OFFSET_PX =
    theme.layout.collapsedHeaderHeight + theme.layout.collapsedTabHeight * 2
