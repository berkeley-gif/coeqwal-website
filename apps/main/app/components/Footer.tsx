...
const PARTNER_LOGOS = [
    { src: "/images/about/logo-uc-ri.png", alt: "UC Research & Innovation", width: 205 },
    { src: "/images/GIF-logo.png", alt: "Geospatial Innovation Facilities", width: 185 },
]
...
const WATER_STORIES = [
    { key: "flow", label: "How water flows through California", href: "https://flow.coeqwal.org" },
    { key: "climate", label: "How climate affects California water", href: "https://climate.coeqwal.org" },
    { key: "managed", label: "How California water is managed", href: "https://management.coeqwal.org" },
    { key: "equity", label: "How equity shapes California water", href: "https://equity.coeqwal.org" },
]
        ...
        >
            ...
            >
                <Typography variant="dashboard">
                    ...
                    This research project is supported by funds from the California Climate Action Seed and Matching Grants Program of the University of California (Grant Number R02CM7222). This funding is part of the California Climate Action Initiative, a $100 million investment in climate action research and innovation projects in the California State Budget Act of 2022-2023.
                </Typography>
                <Box
                    sx={{
                        display: "flex",
            ...
            >
                ...
                <Accordion
                    ...
                    elevation={0}
                    TransitionComponent={
                        Fade as unknown as React.ComponentProps<typeof Accordion>["TransitionComponent"]
                    }
                ...
                >
                    ...
                    <AccordionDetails>
                        <Box component="ul" sx={{ listStyle: "none", padding: 0, fontSize: "14px" }}>
