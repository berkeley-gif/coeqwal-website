...
const SCENARIOS_API_URL = 'https://x66ckhp067.execute-api.us-west-2.amazonaws.com/default/scenarios'
 ...
 */
export function getDownloadUrl(scenarioId: string, fileType: 'zip' | 'output' | 'sv'): string {
