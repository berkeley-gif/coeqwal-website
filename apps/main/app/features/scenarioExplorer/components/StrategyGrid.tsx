              ...
              >
                ...
                {compact ? (
                  <Box sx={{ display: "flex", flexDirection: "column", gap: theme.spacing(1.5) }}>
                    ...
                    <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "stretch", gap: theme.spacing(2) }}>
                      {/* Left column: Title + Description */}
                      <Box sx={{ flex: 1, display: "flex", flexDirection: "column", gap: theme.spacing(1.5) }}>
                        <Typography
                          variant="subtitle1"
                          sx={{
                            fontWeight: theme.typography.fontWeightMedium,
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column", gap: theme.spacing(1.5), flexShrink: 0 }}>
                        <Typography variant="subtitle2">Key operations</Typography>
                        <Box
                          sx={{
                            display: "flex",
                        ...
                        >
                          ...
                          <>
                            <InfoTooltip
                              description={getThemeIconDescription(strategy.theme, strategy.value)}
                              placement="top"
                            >
                              <Box
                                sx={{
                            ...
                            <InfoTooltip description="2020 LandIQ land use" placement="top">
                              <Box sx={{ width: { xs: theme.spacing(4), lg: theme.spacing(5) }, height: { xs: theme.spacing(4), lg: theme.spacing(5) }, cursor: "pointer" }}>
                                {/* eslint-disable-next-line @next/next/no-img-element */}
                                <img
                                  src={CURRENT_OPERATIONS_ICONS[1]?.path || "/images/icons/land_use.svg"}
                                  alt={CURRENT_OPERATIONS_ICONS[1]?.alt || "Land use"}
                          ...
                          <>
                            ...
                            {strategy.value.includes("tucp") && (
                              <InfoTooltip
                                description={CURRENT_OPERATIONS_ICONS[2]?.description || "TUCP included"}
                                placement="top"
                              >
                                <Box sx={{ width: { xs: theme.spacing(4), lg: theme.spacing(5) }, height: { xs: theme.spacing(4), lg: theme.spacing(5) }, cursor: "pointer" }}>
                                  {/* eslint-disable-next-line @next/next/no-img-element */}
                                  <img
                                    src={CURRENT_OPERATIONS_ICONS[2]?.path || "/images/icons/tucp.svg"}
                                    alt={CURRENT_OPERATIONS_ICONS[2]?.alt || "TUCP"}
                                    style={{ width: "100%", height: "100%" }}
                                  />
                                </Box>
                              </InfoTooltip>
                            )}
                            {!strategy.value.includes("tucp") && strategy.theme === "baseline" && (
                              <InfoTooltip description="No TUCP included" placement="top">
                                <Box sx={{ width: { xs: theme.spacing(4), lg: theme.spacing(5) }, height: { xs: theme.spacing(4), lg: theme.spacing(5) }, cursor: "pointer" }}>
                                  {/* eslint-disable-next-line @next/next/no-img-element */}
                                  <img
                          ...
                          {outcomeNames.slice(0, 5).map(({ name, displayName }) => {
                            ...
                            return (
                              <div key={displayName}>
                                ...
                                >
                                  {(() => {
                                    const chartData = isActiveForStrategy ? strategyChartData[displayName] : undefined
                                      ...
                                      <ScenarioGlyph
                                        ...
                                        tierColors={
                                          isActiveForStrategy
                                            ...
                                            : [theme.palette.grey[300], theme.palette.grey[300], theme.palette.grey[300], theme.palette.grey[300]]
                                        }
                                      />
                                    )
                                  })()}
                                  <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", mt: 0.5 }}>
                                    <Typography
                                      ...
                                      sx={{
                                        ...
                                        fontSize: "0.65rem",
                                        fontWeight: theme.typography.fontWeightMedium,
                                        color: isActiveForStrategy ? theme.palette.blue.darkest : theme.palette.grey[500],
                                        lineHeight: 1.2,
                                        maxWidth: "70px",
                                      }}
                                    >
                                    ...
                                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 0, mt: 0.25 }}>
                                      <InfoIconButton
                                        isActive={activeTooltip === name}
                                        onClick={(e) => { e.stopPropagation(); handleToggleWithAnchor(name, e.currentTarget) }}
                                        title="Click for outcome details"
                                      />
                                      {onSortChange && (
                                        <SortButton
                                          sortState={isSortedByThisOutcome ? sortDirection : null}
                                          onAscClick={(e) => { e.stopPropagation(); onSortChange(sortDirection === "asc" ? null : displayName, "asc") }}
                                          onDescClick={(e) => { e.stopPropagation(); onSortChange(sortDirection === "desc" ? null : displayName, "desc") }}
                                          title="Sort by this outcome"
                                        />
                                      )}
                                    </Box>
