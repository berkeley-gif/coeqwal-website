...
export const outcomeMetrics: OutcomeMetric[] = [
  ...
  // ============================================================================
  {
    ...
    description:
      "Tier (1-4) of water supply reliability determined by impact thresholds",
    isTier: true,
    showOnMap: true,
  },
  {
  ...
  // ============================================================================
  {
    ...
    description:
      "Tier (1-4) of agricultural productivity (revenue) determined by impact thresholds",
    isTier: true,
    showOnMap: true,
  },
  {
  ...
  // ============================================================================
  {
    ...
    description:
      "Tier (1-4) flow condition determined by functional flow thresholds",
    isTier: true,
    showOnMap: true,
  },
  {
    ...
    description: "Tier (1-4) Delta estuary condition",
    isTier: true,
    showOnMap: true,
  },
  {
  ...
  // ============================================================================
  {
    ...
    description:
      "Tier (1-4) of overall reservoir storage determined by historical reference thresholds",
    isTier: true,
    showOnMap: true,
  },
  {
  ...
  // ============================================================================
  {
    ...
    description:
      "Tier (1-4) of overall groundwater storage determined by historical reference thresholds",
    isTier: true,
    showOnMap: true,
  },
  {
  ...
  // ============================================================================
  {
    ...
    description: "Tier (1-4) of population status of winter run chinook salmon",
    isTier: true,
    showOnMap: false,
  },
  {
