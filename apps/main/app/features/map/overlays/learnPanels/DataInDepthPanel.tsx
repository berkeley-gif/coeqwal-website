  ...
  return (
    <PanelShell background={theme.palette.nature.forest}>
      ...
      <Typography variant="body2" color="text.secondary">
        ...
        viewer. These variables describe different features of the water system,
        including river flows, water delivery amounts, reservoir and groundwater
        storage levels, and <GlossaryTermLink>salinity</GlossaryTermLink>{" "}
        conditions within the Bay-Delta estuary.
      </Typography>
      <Typography variant="body2" color="text.secondary" sx={{ mt: sp.md }}>
        ...
        viewer, you can generate plots of these additional outcome variables to
        understand how they vary under different locations, water year types,{" "}
