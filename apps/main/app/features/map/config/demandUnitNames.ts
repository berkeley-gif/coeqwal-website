...
export const DEMAND_UNIT_NAMES: Record<string, DemandUnitNameInfo> = {
  ...
  "02_PU": {
    urbName: "Keswick",
    modName: "Shasta Co S.A. #25 - Keswick C.S.D.",
  },
  ...
  "07N_NU": {
    urbName: "Willows",
    modName: "California Water Service Co. (Willows)",
  },
  ...
  "10_NU1": {
    urbName: "Chico",
    modName: "California Water Service Co. (Chico)",
  },
  ...
  "15N_NU": {
    urbName: "Marysville",
    modName: "California Water Service Co. (Marysville)",
  },
  ...
  "22_NU": {
    urbName: "Sac Int'l Airport - SCWA Zone 50",
    modName: "Sacramento County Water Agency",
  },
  ...
  "24_NU1": {
    urbName: "Christian Valley Park",
    modName: "Christian Valley Park C.S.D.",
  },
  ...
  "25_NU": {
    urbName: "Dixon",
    modName: "California Water Service Co. (Dixon)",
  },
  ...
  "26N_NA": {
    subName: "PCWA Zone 5",
    urbName: "Placer Vineyards",
    modName: "California American Water",
  },
  "26N_NU1": {
    subName: "Arbors at Antelope",
    urbName: "North Highlands",
    modName: "Sacramento Suburban Water District",
  },
  "26N_NU2": { urbName: "Carmichael", modName: "Carmichael Water District" },
  "26N_NU3": {
    urbName: "Sacramento",
    modName: "City of Sacramento - North of American River",
  },
  "26N_NU4": {
    subName: "Arcade-Town and Country (Outside ARPOU)",
    urbName: "Arcade-Town and Country (Outside ARPOU)",
    modName: "Sacramento Suburban Water District",
  },
  "26N_NU5": { urbName: "Arden", modName: "California American Water" },
  "26N_PU1": { urbName: "Roseville", modName: "City of Roseville" },
  "26N_PU2": {
    subName: "City of Roseville Retail Area",
    urbName: "City of Roseville",
    modName: "San Juan Water District",
  },
  "26N_PU3": {
    subName: "North of American River",
    urbName: "Folsom",
    modName: "City of Folsom",
  },
  "26S_NU1": {
    urbName: "Sacramento",
    modName: "City of Sacramento - South of American River",
  },
  "26S_NU2": {
    subName: "Rosemont (Within ARPOU)",
    urbName: "Rosemont (Within ARPOU)",
    modName: "California American Water",
  },
  "26S_NU3": {
    urbName: "Parkway, Unicorporated Sacramento County",
    modName: "Fruitridge Vista W.C.",
  },
  "26S_NA": { modName: "Non-District Ag" },
  "26S_PU1": { modName: "Folsom State Prison" },
  "26S_PU2": {
    urbName: "Rancho Cordova",
    modName: "Golden State Water Company",
  },
  "26S_PU3": { modName: "California Parks and Recreation" },
  "26S_PU4": {
    subName: "Laguna, Franklin",
    urbName: "Laguna",
    modName: "Sacramento County Water Agency - Zone 41",
  },
  "26S_PU5": {
    subName: "Elk Grove Water Service",
    urbName: "Elk Grove",
    modName: "Florin Resource Conservation District - within Zone 40",
  },
  "26S_PU6": {
    urbName: "Sunrise",
    modName: "Sacramento County Water Agency - Zone 41",
  ...
  "60N_PU": {
    urbName: "SMUD Rancho Seco Power Plant",
    modName: "SMUD Rancho Seco Power Plant",
  },
  ...
  "61_NU1": {
    subName: "Del Este Water Company",
    urbName: "Waterford",
    modName: "Modesto ID",
  },
  ...
  "61_PA1": {
    subName: "North of Stanislaus River",
    modName: "Oakdale ID North of Stanislaus River",
  },
  "61_PA2": {
    subName: "South of Stanislaus River",
    modName: "Oakdale ID South of Stanislaus River",
  },
  ...
  "62_NA6": {
    subName: "North of Meced River",
    modName: "Merced ID North of Meced River",
  },
  "62_NU": {
    subName: "Keyes Community S.D.",
    urbName: "Keyes",
    modName: "Turlock I.D.",
  },
  ...
  "63_NA3": {
    subName: "South of Merced River",
    modName: "Merced ID South of Merced River",
  },
  ...
  "64_NA1": {
    urbName: "Madera Acres",
    modName: "East of Madera ID - DAU 213,199,204",
  },
  "64_NA2": { modName: "West of Madera ID and Chowchilla WD" },
  "64_NU": {
    subName: "CITY OF MADERA W.S.A.",
    urbName: "Madera",
    modName: "East of Madera ID - DAU 213,199,204",
  },
  ...
  "71_PU1": {
    subName: "Plain View W.D.",
    urbName: "Musco Family Olive Company",
    modName: "Byron Bethany I.D.",
  },
  ...
  "72_XA2": {
    subName: "Central California I.D. (South)",
    modName: "Central California I.D. (South)",
  },
  "72_XA3": {
    subName: "Central California I.D. (North)",
    modName: "Central California I.D. (North)",
  },
  "73_NA": { modName: "Non-District Ag\\Urban" },
  "73_PA1": {
    subName: "San Luis W.D. (North)",
    modName: "San Luis W.D. (North)",
  },
  "73_PA2": { modName: "Widren W.D." },
  "73_PA3": {
    subName: "San Luis W.D. (South)",
    modName: "San Luis W.D. (South)",
  },
  "73_XA": {
    subName: "Firebaugh Canal W.D. (North)",
    modName: "Firebaugh Canal W.D. (North)",
  },
  "90_NA": {},
  "90_PA1": { subName: "Westlands W.D. (East)", modName: "Priority Area 1" },
  "90_PA2": {
    subName: "Westlands W.D. (West)",
    modName: "Distribution District #2",
  },
