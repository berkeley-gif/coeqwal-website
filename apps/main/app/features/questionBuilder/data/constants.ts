    ...
    options: [
      {
        ...
        labelEs: "Community water",
        shortText: "community water",
        shortTextEs: "community water",
      },
      {
        id: "agricultural_water",
        label: "Agricultural water",
        labelEs: "Agua agrícola",
        shortText: "agricultural water",
        shortTextEs: "agua agrícola",
      },
      {
        id: "environmental_water",
        label: "Environmental water",
        labelEs: "Environmental water",
        shortText: "environmental water",
        shortTextEs: "environmental water",
      },
      {
        id: "delta_salinity",
        label: "Delta salinity",
        labelEs: "Salinidad del Delta",
        shortText: "delta salinity",
        shortTextEs: "salinidad del Delta",
      },
      {
        id: "reservoir_storage",
        label: "Reservoir storage",
        labelEs: "Almacenamiento de embalses",
        shortText: "reservoir storage",
        shortTextEs: "almacenamiento de embalses",
      },
      {
        id: "groundwater_levels",
        label: "Groundwater levels",
        ...
        shortTextEs: "niveles de agua subterránea",
      },
      {
        id: "distributional_equity",
        label: "Distributional equity",
        labelEs: "Equidad de distribución",
        shortText: "distributional equity",
        shortTextEs: "equidad de distribución",
      },
      {
        id: "climate_resilience",
        label: "Climate resilience",
        labelEs: "Resiliencia climática",
