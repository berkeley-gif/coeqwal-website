...
import { Typography, useTheme, Box, ToggleButtonGroup, ToggleButton } from "@repo/ui/mui"
...
const ScenarioCard: React.FC<ScenarioCardProps> = ({
  ...
  useEffect(() => {
    if (chartType === 'line' && !monthlyData) {
      ...
      const fallbackData = {
        overall: {
          "1": 34.36, "2": 36.74, "3": 42.70, "4": 38.95, 
          "5": 39.95, "6": 25.25, "7": 11.59, "8": 6.34, 
          "9": 5.28, "10": 6.18, "11": 8.67, "12": 22.41
        },
        dry: {
          "1": 35.54, "2": 37.86, "3": 45.35, "4": 41.87, 
          "5": 43.38, "6": 27.59, "7": 12.51, "8": 6.71, 
          "9": 5.53, "10": 6.46, "11": 9.16, "12": 23.29
        },
        wet: {
          "1": 34.36, "2": 36.74, "3": 42.70, "4": 38.95, 
          "5": 39.95, "6": 25.25, "7": 11.59, "8": 6.34, 
      ...
      Promise.any([
        ...
        fetch('/scenario_data/s9999_inflows/_aggregates.json').then(r => r.json()),
        fetch('/apps/main/public/scenario_data/s9999_inflows/_aggregates.json').then(r => r.json())
      ])
      .then(data => {
