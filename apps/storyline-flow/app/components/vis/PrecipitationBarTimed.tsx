...
//NOTE: I am only keeping this file for reference, it is not used in the current codebase.
        ...
        return (
          <g key={idx} className="bars">
            <motion.rect
              x={xPos}
              width={barWidth}
              fill={d.anomaly < 0 ? "transparent" : "#50B1E7"}
              stroke={d.anomaly < 0 ? "#50B1E7" : "none"}
