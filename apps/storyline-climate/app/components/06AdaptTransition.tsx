  ...
  return (
    <StickyContainer
      ...
      <Box
        ...
        height='100%'
        sx={{
          position: 'absolute', "--rain-color": FreshWaterColor, overflow: 'hidden',}}
      >
        <RainAnimation/>
      </Box>
      ...
      <SVGLineContainer viewBox="-270 0 1261 1145">
        <motion.path 
          ...
          d="M422.118 -41C422.118 -41 714.118 29.8119 720.118 87C726.118 144.188 531.118 58 614.118 181C697.118 304 929.118 80 928.118 225C927.118 370 663.118 365 782.118 403C901.118 441 898.118 188 782.118 274C666.118 360 1009.12 273 973.118 374C937.118 475 876.118 570 804.118 492C732.118 414 839.118 434 928.118 364C1017.12 294 931.118 555 1021.12 424C1111.12 293 817.118 433 816.118 522C815.118 611 643.118 720 543.118 726C443.118 732 245.118 894 303.118 941C361.118 988 118.118 1163 0.118164 1156"
        />
        <motion.path 
          className='svg-line'
      ...
      <Box className='text-section'
        ...
        <Box className="paragraph" component="article">
          <Typography variant="body1" gutterBottom>
            ...
            <span className='highlight-text'>{"how climate will affect California’s water system"}</span>
            {" in the future."}
          </Typography>
          <Typography variant="body1" gutterBottom>
            {"This is, in part, because "}
            <span style={{ fontWeight: 'bold' }}>{"the impacts of climate change depend on the actions that we take"}</span>
            {"."}
          </Typography>
        </Box>
        <Box className="paragraph" component="article">
