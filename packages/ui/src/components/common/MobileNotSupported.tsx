...
export function MobileNotSupported() {
    ...
    return (
        <Box sx={{
            ...
            <Typography variant="body1">Due to the nature of the tools, this section of COEQWAL is best used on a tablet, desktop or laptop computer</Typography>
            <Button variant="contained" href="/">Go to the homepage</Button>
        </Box>
    )
}
