 ...
 * 
 * 1. withMap: A functional approach to work with the map that automatically handles null checking.
 ...
 *    ```
 * 
 * 2. getMap: Direct access to the map instance when you need it.
