...
const TierSankey: React.FC<TierSankeyProps> = React.memo(
  ({
    data,
    outcomeName,
          ...
          for (const flow of sortedFlows) {
            ...
            g.append("path")
              ...
              .on("mouseenter", function (event: MouseEvent) {
                select(this).attr("fill-opacity", Math.min(opacity + 0.3, 0.85))
              ...
              .on("mouseleave", function () {
                select(this).attr("fill-opacity", opacity)
                setTooltip(null)
...
TierSankey.displayName = "TierSankey"
