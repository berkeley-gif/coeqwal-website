...
import { packEnclose, packSiblings } from "d3"
...
const PackedDots: React.FC<PackedDotsProps> = React.memo(
  ({
    dots,
    size,
    dotRadius = 7,
    ...
    const packed = useMemo((): PackedCircle[] => {
      ...
      const enclosing = packEnclose(siblings)
...
PackedDots.displayName = "PackedDots"
