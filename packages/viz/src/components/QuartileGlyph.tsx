...
const QuartileGlyph: React.FC<QuartileGlyphProps> = React.memo(
  ({ values, size = 60, colors = defaultColors }) => {
...
QuartileGlyph.displayName = "QuartileGlyph"

export default QuartileGlyph
