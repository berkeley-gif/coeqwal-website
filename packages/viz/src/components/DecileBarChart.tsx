...
import { DecileBarChartProps, DecileData } from "../types"
import {
  parseDecileData,
...
const DecileBarChart: React.FC<DecileBarChartProps> = React.memo(
  ({
    data,
    width = 60,
    height = 280,
    ...
    const updateChart = useCallback(
      (w: number, h: number) => {
        ...
        const maxValue = max(sortedData, (d) => d.value) || 100
        ...
        const colorScale = createDecileColorScale(
          colorScheme,
          sortedData.length,
        )
...
DecileBarChart.displayName = "DecileBarChart"
